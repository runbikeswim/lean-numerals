...
theorem toNat_helper_eq_zero_of_equiv_helper_nil {base : NatGtOne} {a : List base.Fin}
  (h: equiv.helper base [] a) : toNat.helper base a.toListNatAux 1 0 = 0 := by
  induction a with
...
theorem equiv_helper_nil_of_toNat_helper_zero {base : NatGtOne} {a : List base.Fin}
  (h: toNat.helper base a.toListNatAux 1 0 = 0) : equiv.helper base [] a := by
  induction a with
  ...
  | cons x xs ih =>
    ...
    have h3 : toNat.helper base xs.toListNatAux 1 0 = 0 := by
      cases h2 with
...
theorem equiv_helper_iff_toNat__helper_eq {base : NatGtOne} {a b : List base.Fin} :
  equiv.helper base a b ↔ toNat.helper base a.toListNatAux 1 0 = toNat.helper base b.toListNatAux 1 0 :=
